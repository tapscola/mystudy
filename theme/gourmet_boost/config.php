...
$THEME->csstreepostprocessor = 'theme_gourmet_boost_css_tree_post_processor';
$THEME->extrascsscallback = 'theme_gourmet_boost_get_extra_scss';
$THEME->prescsscallback = 'theme_gourmet_boost_get_pre_scss';
...
$THEME->scss = function($theme) {
    return theme_gourmet_boost_get_main_scss_content($theme);
};
